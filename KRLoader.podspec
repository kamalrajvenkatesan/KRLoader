...
Pod::Spec.new do |s|
  s.name             = 'KRLoader'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KRLoader.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kamalraj.venkatesan/KRLoader'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kamalraj.venkatesan' => 'kamalraj.venkatesan@gyanmatrix.com' }
  s.source           = { :git => 'https://github.com/kamalraj.venkatesan/KRLoader.git', :tag => s.version.to_s }
